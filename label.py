...
if __name__ == "__main__" :
	...
	label1 = Label(root, text = "enter the sentence",
	...
	language1_field = Text(root, height = 5, width = 50,font = "lucida 13")
	language2_field = Text(root, height = 5, width = 50,font = "lucida 13")		
